        ...
        <div key={index}>
          {index < numItems && (
            <Link
              ...
              className="relative w-full h-[600px] bg-white flex flex-col items-center rounded-xl border border-solid border-[#afe6d8] transition-opacity duration-200 ease-in-out"
            ...
            >
              ...
              >
                {/* Text inside overlay */}
                <span
                  className={`text-4xl text-[#f93a97] text-shadow-sm shadow-[#64173c] font-benedict tracking-wide transition-opacity duration-500 ${
              ...
              <div className="w-full min-h-[60%] relative overflow-hidden rounded-t-xl">
                <Image
              ...
              <div className="flex gap-4 p-4">
                <h3 className="w-1/3 text-[#f93a97] font-ubuntu tracking-wide uppercase">
                  {property.title}
                </h3>
